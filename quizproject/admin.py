...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ('quiz', 'questions', 'created_on')  
admin.site.register(Question, QuestionAdmin)


# Register the Answer model with the admin interface
class AnswerAdmin(admin.ModelAdmin):
    list_display = ('question', 'answer', 'is_correct','answer_type','created_on') 
...
class UserStatAdmin(admin.ModelAdmin):
    list_display = ('user', 'quiz', 'score', 'time_taken','date_taken')  
